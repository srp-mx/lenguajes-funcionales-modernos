...
\begin{document}
    ...
    a causar que las expresion lambda exploten en tamaño al ser compiladas a SKI.\cite{lambdaToSKI} Esto lo podemos con la expresión $\lambda x. \lambda y. \, y \, x$, pues 
    ...
    \begin{center}
        $(\models \, d') II (\models \, d) = d' \, d$\\
        $(\models \, d') II (\tau_n,\ldots,\tau_1 \models \, d) = (\models \, Bd') \, (\tau_n,\ldots,\tau_1 \models \, d)$\\
        $(\tau_n,\ldots,\tau_1 \models \, d') II (\models \, d) = (\models \, CCd) \, (\tau_n,\ldots,\tau_1 \models \, d')$\\
        $(\tau_n,\ldots,\tau_1 \models \, d') II (\tau_m,\ldots,\tau_1 \models \, d') = (\tau_n,\ldots,\tau_1 \models (\models S) \, II \, (\tau_n,\ldots,\tau_1 \models \, d')) \, 
        II \, (\tau_m,\ldots,\tau_1 \models \, d)$\\
    \end{center}
\end{document}
