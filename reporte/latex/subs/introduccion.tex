...
\item \boldit{Evaluación perezosa}
  ...
  \cite[p.~142]{richard-philip-introflp-1998}. Más adelante será necesario
  notar que este tipo de evaluación, además requiere que su implementación
  permita asegurar que las expresiones sean evaluadas un sola vez y en caso
  de volver a aparecer permitir la reutilización del valor ya calculado
  \cite[p.~194]{peytonjones1987the} para contribuir en la mejora del
  tiempo de ejecución.
